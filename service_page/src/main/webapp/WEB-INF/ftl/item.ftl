						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text" value="1" minnum="1" v-model="num" class="itxt" />
	...
	new Vue({
		...
		methods:{
			...
			addToCart:function () {//加入购物车
				axios.get("http://localhost:8085/cart/addGoodsToCartList.do",
						{params:{itemId:this.sku.id,num:this.num}})
						.then(function (response) {
							alert(response)
							if (response.data.success){
								alert("跳转http://localhost:8085/cart.html");
